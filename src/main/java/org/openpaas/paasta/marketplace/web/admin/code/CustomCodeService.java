...
public class CustomCodeService {
    ...
    public List<CustomCode> getUnitCodeListByGroupCode(String groupCode) {
    	CustomCodeList codeList = marketApiRest.send(AdminConstants.TARGET_API_MARKET, AdminConstants.URI_API_CUSTOM_CODE + "/" + groupCode, HttpMethod.GET, null, CustomCodeList.class);
